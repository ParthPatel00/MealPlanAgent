...
5. Browse results across tabs: Meal Plan, Grocery & Budget, Nutrition, Calendar, Agent Trace, Memory
6. Download the `.ics` file from the Calendar tab to import into Google/Apple/Outlook Calendar
